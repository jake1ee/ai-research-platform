        ...
        <div className="bg-white py-8 px-4 shadow-sm border border-zinc-200 sm:rounded-3xl sm:px-10">
          <form className="space-y-6" action="#" method="POST">
            <div>
              ...
              <div className="mt-1">
                <input id="name" name="name" type="text" required className="block w-full appearance-none rounded-xl border border-zinc-300 px-4 py-3 placeholder-zinc-400 shadow-sm focus:border-black focus:outline-none focus:ring-black sm:text-sm" />
              </div>
            </div>
